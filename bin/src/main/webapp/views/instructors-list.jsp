        ...
        <div class="instructor-card">
            <div class="instructor-info">
                ...
                <div>
                    ...
                    <p class="instructor-department"><c:out value="${instructor.department}"/></p>
                </div>
            </div>
            <div class="instructor-details">
                <p><strong>Phone:</strong> <c:out value="${instructor.phoneNumber}"/></p>
                <p><strong>Address:</strong> <c:out value="${instructor.address}"/></p>
